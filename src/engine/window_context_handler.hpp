...
public:
    ...
    void drawDirect(const sf::Drawable& drawable, sf::Transform const& transform)
    {
    ...
    {
        render_states.transform = m_viewport_handler.getTransform() * render_states.transform;
